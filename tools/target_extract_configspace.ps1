# target_extract_configspace.ps1
...
#
# Usage: powershell -ExecutionPolicy Bypass -File target_extract_configspace.ps1
...
Write-Host ""
Write-Host "Transfer both files to the reader PC's tools/donor_data/ directory."
Write-Host "============================================================"
