#!/usr/bin/env python3
"""
Extract NVMe BAR0 registers and MSI-X table from the donor NE-256 SSD via DMA.
...
Prerequisites: Run 01_extract_config_space.py first.

Usage:
    python 02_extract_bar0.py
    python 02_extract_bar0.py --bar0-addr 0xFE600000   # Manual BAR0 address
"""
...
def main():
    ...
    parser.add_argument("--output-dir", default=DONOR_DIR, help="Output directory")
    ...
    if bar0_addr is None:
        ...
        if bar0_addr is None or bar0_addr == 0:
            ...
            print("Either run 01_extract_config_space.py first, or specify --bar0-addr")
            sys.exit(1)
    ...
    # Determine read size
    config_bin_path = os.path.join(DONOR_DIR, "config_space_4k.bin")
    config_data = None
