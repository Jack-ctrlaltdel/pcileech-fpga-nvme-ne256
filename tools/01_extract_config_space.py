#!/usr/bin/env python3
"""
Extract full 4KB PCI Extended Config Space from NE-256 NVMe SSD via ECAM DMA read.

Uses the PCILeech DMA device (via memprocfs/leechcore) to read the ECAM-mapped
configuration space of the donor NVMe controller.

Usage:
    python 01_extract_config_space.py
    python 01_extract_config_space.py --bus 5 --dev 0 --fun 0
    python 01_extract_config_space.py --ecam-base 0xE0000000
    python 01_extract_config_space.py --scan   # Scan all buses for VEN_126F/DEV_2263
"""
...
def main():
    ...
    if ecam_base is None:
        ...
        if ecam_base is None:
            ...
            print("  python 01_extract_config_space.py --parse donor_data/config_space_4k.bin")
            sys.exit(1)
