# target_extract_all.ps1
# ============================================================
# Run on TARGET PC as Administrator
# Extracts full PCI config space + BAR0 NVMe registers from NE-256
# Transfer output files to reader PC: tools/donor_data/
# ============================================================
# Usage: powershell -ExecutionPolicy Bypass -File target_extract_all.ps1
# ============================================================
...
Write-Host "    -> tools/donor_data/config_space_4k.bin" -ForegroundColor Cyan
Write-Host "    -> tools/donor_data/nvme_bar0.bin" -ForegroundColor Cyan
Write-Host "    -> tools/donor_data/device_info.json" -ForegroundColor Cyan
Write-Host ""
Write-Host "  Then on reader PC run:" -ForegroundColor White
Write-Host "    python 01_extract_config_space.py   (to parse)" -ForegroundColor Gray
Write-Host "    python 04_generate_coe.py           (to generate COE)" -ForegroundColor Gray
Write-Host "============================================================" -ForegroundColor White
