...
set files [list \
 ...
 [file normalize "${origin_dir}/src/pcileech_nvme_controller.sv"]\
 [file normalize "${origin_dir}/src/pcileech_nvme_engine.sv"]\
...
set file "src/pcileech_nvme_controller.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "src/pcileech_nvme_engine.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
